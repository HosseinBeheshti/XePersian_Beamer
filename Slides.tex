...
\begin{figure}
    \begin{overprint}
    \onslide<1>\includegraphics[scale=0.4]{Images/HPfig1.png}
    \onslide<2>\includegraphics[scale=0.4]{Images/HPfig2.png}
    \onslide<3>\includegraphics[scale=0.4]{Images/HPfig3.png}
    \end{overprint}
\end{figure}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}
	\centering
	\includestandalone[scale=0.4]{Images/SimFig1}
\end{figure}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
...
\begin{figure}
	\centering
	\includestandalone[scale=0.4]{Images/SimFig2}
\end{figure}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%
